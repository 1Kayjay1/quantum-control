...
export const OFFICIAL_FIELD_DIMENSIONS_CM = {
  archGate: {
    ...
    innerWidth: 152.4,
    innerHeight: 160.0,
    depth: 20.3,  // Estimated depth for structure
  },
  keyholeGate: {
    outerDiameter: 76.2,
    innerDiameter: 61.0,
    depth: 15.2,  // Estimated depth
  },
  landingPad: {
    outerDiameter: 76.2,
    bullseyeDiameter: 25.4,
    thickness: 4,
  },
  programmingMat: {
    width: 243.8,
  ...
  flyThroughPanel: {
    ...
    totalSections: 3,
    height: 91.4,
    largeHoleDiameter: 25.4,
    smallHoleDiameter: 20.3,
    depth: 10.2,  // Estimated depth for corrugated plastic
  },
  tunnel: {
    diameter: 59.7,
    length: 48.3,
