...
export const OFFICIAL_FIELD_DIMENSIONS_CM = {
  archGate: {
    outerWidth: inchesToCm(102),
    outerHeight: inchesToCm(74),
    innerWidth: inchesToCm(60),
    innerHeight: inchesToCm(63),
    depth: inchesToCm(8),
  },
  keyholeGate: {
    outerDiameter: inchesToCm(30),
    innerDiameter: inchesToCm(24),
    depth: inchesToCm(6),
  },
  landingPad: {
    outerDiameter: inchesToCm(30),
    bullseyeDiameter: inchesToCm(10),
    thickness: 4,
  },
  programmingMat: {
    width: inchesToCm(96),
  ...
  colorMat: {
    width: inchesToCm(24),
    height: inchesToCm(24),
    thickness: 1.5,
  },
  flyThroughPanel: {
    sectionWidth: inchesToCm(20),
    totalSections: 3,
    height: inchesToCm(36),
    largeHoleDiameter: inchesToCm(10),
    smallHoleDiameter: inchesToCm(8),
    depth: inchesToCm(4),
  },
  tunnel: {
    diameter: inchesToCm(23.5),
    length: inchesToCm(19),
  },
  miniArchGate: {
    outerWidth: inchesToCm(37),
    outerHeight: inchesToCm(32),
    innerWidth: inchesToCm(28),
    innerHeight: inchesToCm(28),
    tensionStringHeight: inchesToCm(4.5),
    depth: inchesToCm(6),
  },
  cubeLarge: {
    width: inchesToCm(17),
    length: inchesToCm(17),
    height: inchesToCm(20),
  },
  cubeSmall: {
    width: inchesToCm(12),
    length: inchesToCm(12),
    height: inchesToCm(13),
  },
  pillar: {
    height: inchesToCm(12),
    diameter: inchesToCm(3),
  },
} as const
