...
export function FieldViewport() {
  ...
  return (
    <section className="relative h-[clamp(560px,66vh,740px)] min-h-0 w-full overflow-hidden rounded-[22px] bg-[radial-gradient(circle_at_22%_10%,rgba(116,182,255,0.12),transparent_22%),linear-gradient(180deg,rgba(32,67,126,0.96)_0%,rgba(14,31,70,0.98)_42%,rgba(20,44,25,0.98)_42.5%,rgba(10,19,15,1)_100%)] max-[900px]:h-[clamp(440px,56vh,540px)]">
      <Canvas
